package com.remotefalcon.api.service.legacy;
...
import com.remotefalcon.api.util.legacy.AuthUtilLegacy;
import com.remotefalcon.api.util.ClientUtil;
import com.remotefalcon.api.util.legacy.EmailUtilLegacy;
...
@Service
public class AccountServiceLegacy {
  ...
  private final EmailUtilLegacy emailUtil;
  private final DozerBeanMapper mapper;
  private final AuthUtilLegacy authUtil;
  private final ClientUtil clientUtil;

  @Autowired
  public AccountServiceLegacy(RemoteRepository remoteRepository, PasswordResetRepository passwordResetRepository, RemotePreferenceRepository remotePreferenceRepository,
                        DefaultViewerPageRepository defaultViewerPageRepository, EmailUtilLegacy emailUtil, DozerBeanMapper mapper, AuthUtilLegacy authUtil, ClientUtil clientUtil) {
